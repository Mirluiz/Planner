import { Geometry, Object3D, Storage } from "../../../";
import * as THREE from "three";
import { Mesh, BaseMesh } from "../Mesh";
import { TextGeometry } from "three/examples/jsm/geometries/TextGeometry";

class BoxLine extends BaseMesh implements Mesh {
  endAngle = 0;
  startAngle = 0;
  constructor(private model: Object3D & Geometry.Line) {
    super();
  }
  ...
  private getGeometry() {
    ...
    let endAngle = this.endAngle; // is angle
    ...
    let startAngle = this.startAngle; // is angle
