...
// import { Vector3 } from "../service/geometry";
// import { App } from "../App";
// import { planeIntersection } from "../service/math";
// import { SnapHighlight } from "../service/SnapUI";
...
//           // new Fitting({
//           //   position: {
//           //     x: this.groundInters.x,
//           //     y: this.groundInters.y,
//           //     z: this.groundInters.z,
//           //   },
//           // });
//           break;
//         case "wall":
//           if (this.app.wallController.active) {
//             this.app.wallController.end({ ...this.groundIntersNet });
//             this.app.wallController.start({ ...this.groundIntersNet });
//           } else {
//             this.app.wallController.start({ ...this.groundIntersNet });
//           }
//           break;
//         case "blue_pipe":
//         case "red_pipe":
//           if (this.app.pipeController.active) {
//             this.app.pipeController.end({ ...this.groundIntersNet });
//
//             this.app.pipeController.start(
//               { ...this.groundIntersNet },
//               this.drawingMode === "blue_pipe" ? "blue" : "red"
//             );
//           } else {
//             this.app.pipeController.start(
//               { ...this.groundIntersNet },
...
//
//       if (this.app.wallController.active) {
//         this.app.wallController.moveEnd(this.app.wallController.active.end, {
//           x: this.groundIntersNet.x,
//           y: this.groundIntersNet.y,
//           z: this.groundIntersNet.z,
//         });
//
//         this.app.event.emit(
//           "scene_update_element",
//           this.app.wallController.active
//         );
//       }
//
//       if (this.app.pipeController.active) {
//         this.app.pipeController.moveEnd(this.app.pipeController.active.end, {
//           x: this.groundIntersNet.x,
//           y: this.groundIntersNet.y,
//           z: this.groundIntersNet.z,
//         });
...
//         this.app.event.emit(
//           "scene_update_element",
//           this.app.pipeController.active
//         );
//       }
//     });
//
...
//         this.app.pipeController.reset();
//         this.app.wallController.reset();
//
//         this.controls.enabled = true;
//         this.drawingMode = null;
//         this.app.event.emit("scene_update");
//       }
//
...
//     this.app.event.subscribe("scene_update", () => {
...
//
//       this.app.sceneController.model.objects.map((object) => {
...
//     });
//
//     this.app.event.subscribe("scene_update_element", (object) => {
//       if (!this.scene) return;
//
//       object.update();
//     });
...
//     );
//
//     const planeIntersect = planeIntersection(
//       new Vector3(0, 0, 0),
//       this.raycaster.ray
//     ).clone();
//
...
//     this.app.sceneController.model.intersects = [];
//
//     intersects.map((intersect) => {
//       if (intersect.object.userData.object) {
//         this.app.sceneController.model.intersects.push({
